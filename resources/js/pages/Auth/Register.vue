  ...
  <GuestLayout title="Create a new account">
    <template #action>
      <p class="mt-2 text-sm leading-6">
        Already registered?
        <Link :href="route('login')" class="font-semibold text-ring hover:text-ring/50">
        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <Label for="terms" class="mr-3 block text-sm leading-6 text-foreground">
                Accept terms
              </Label>
              <Checkbox
                id="terms"
            ...
            <div class="text-sm leading-6">
              <Link :href="route('pages:terms')" class="font-semibold text-ring hover:text-ring/50">
                Read the terms
              </Link>
            </div>
          </div>
